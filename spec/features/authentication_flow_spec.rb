...
RSpec.describe "Authentication flow", type: :feature do
  ...
  it "signs in and signs out successfully" do
    ...
    expect(page).to have_css("#flash [data-controller='flash']", text: I18n.t("devise.sessions.signed_in"))
    ...
    expect(page).to have_css("#flash [data-controller='flash']", text: I18n.t("devise.sessions.signed_out"))
  end
end
